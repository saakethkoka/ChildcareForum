...
import {savePost, unSavePost} from "../../../../../../kokaAPI";
...
function LongMenu(props) {
    ...
    const unSave = () =>{
        props.removedSavePost(props.postID)
        handleClose()
    }
    ...
    return (
        <div style={{float: "right"}}>
            ...
            >
                {props.saved && options.map((option) => (
                    <MenuItem key={option} selected={option === 'Pyxis'} onClick={() => unSave()}>
                        Unsave Post
                    </MenuItem>
        ...
        <Grid md={6} sm={12} containers>
            <Card sx={{
                ...
                <CardContent sx={{
                    ...
                    <LongMenu postID={post.postID} saved = {saved} removedSavePost = {props.removedSavePost}/>
